...
function validarCampo(e) { // FUNCAO CRIADA E CHAMADA NO HTML PARA VALIDAR MEU FORM
    e.preventDefault() // PARA IMPEDIR QUE O SITE RECARREGUE
    var error = false;

    var tipo = document.getElementById("tipo").value; // PEGANDO O VALOR DO TIPO
